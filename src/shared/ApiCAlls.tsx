...
export const loginRequest = async (
  ...
  let returnValue;
  await axios
    .post(`https://localhost:44326/login?password=${password}&email=${email}`)
    .then((response) => {
      returnValue = response.data;
    });
  console.log(returnValue);
...
export const addCatToFavorite = async (
  ...
  let returnValue;
  await axios
    .post(`https://localhost:44326/addFavorite?catId=${catId}&userId=${userId}`)
    .then((response) => (returnValue = response.data));
...
export const deleteCatFromFavorite = async (
  ...
  await axios
    .post(
      `https://localhost:44326/removeFavorite?catId=${catId}&userId=${userId}`
    )
    .then((response) => (returnValue = response));
...
export const getUserFavoriteCats = async (userId: string): Promise<any> => {
  let returnValue;
  await axios
    .get(`https://localhost:44326/favoriteCats?userId=${userId}`)
    .then((response) => (returnValue = response.data));
